import { i as require_jsx_runtime, t as useForm } from "../_libs/@tanstack/react-form+[...].mjs";
import { t as Icon } from "./Icon-BxtODSXJ.mjs";
import { f as executeCommand, m as repositories, n as EmptyState, s as createDemoAccount, t as Card } from "./Card-NQF5GieP.mjs";
import { a as useQueryClient, r as useQuery } from "../_libs/tanstack__react-query.mjs";
import { a as Route$4 } from "./router-D2nkK8AS.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/help._publicToken-BzyfuQMW.js
...
function HelperRoute() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "Decision sent to Mom." }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: decision.data.outcome === "recommend_plan" ? `${decision.data.recommendedPlanId} was explicitly recommended.` : "Mom will make the plan choice." })]
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "Mom cannot access the demonstrated Gold plan." }),
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(form.Field, {
						...
						children: (field) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("fieldset", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("legend", { children: "Recommendation" }), [
								...
								["let_recipient_decide", "Let Mom decide"]
