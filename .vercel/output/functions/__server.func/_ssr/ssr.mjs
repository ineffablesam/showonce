...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CDwlWo-h.mjs");
...
var manifest = {
	"005eae4d6b0b924eb86424640d325c1cabebb8dd965698638c40d9337b4b7e7b": {
		...
		importer: () => import("./sharedServerFns-DJY8V9g9.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D2nkK8AS.mjs").then((n) => n.t),
