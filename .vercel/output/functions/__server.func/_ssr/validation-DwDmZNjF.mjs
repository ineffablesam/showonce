//#region node_modules/.nitro/vite/services/ssr/assets/validation-DwDmZNjF.js
var TOKEN_BYTES = 18;
var transitions = {
...
function validateHandoff(value) {
	...
	if (record.recipient !== void 0 && record.recipient !== "Mom") throw new Error("Handoff recipient is invalid");
