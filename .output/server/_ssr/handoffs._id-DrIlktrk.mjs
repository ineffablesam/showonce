...
import { m as repositories, n as EmptyState, s as createDemoAccount, t as Card, u as createRecipientAccount } from "./Card-BvuBlAzF.mjs";
import { i as compareProcedureToRecipient, t as SHOWONCE_TOOLS } from "./useWebMCP-DXk4KqFy.mjs";
import { r as useQuery } from "../_libs/tanstack__react-query.mjs";
import { t as AppShell } from "./AppShell-C0CT2omY.mjs";
import { o as Route$5 } from "./router-VfESfXhW.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/handoffs._id-DrIlktrk.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { children: "Recipient link" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { children: sharePath }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "share-card__hint",
							children: "Paste this into a WebMCP-capable browser (e.g. ChatGPT) and say “Do what Samuel showed me.”"
						})
					] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						type: "button",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { name: copied ? "check" : "clipboard" }), copied ? "Copied" : "Copy link"]
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", { children: [recipientName, "’s account stays authoritative"] }),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [recipientName, " chooses or requests a minimum-information decision."] })
					] })
				]
			})
		]
