...
import { a as validateActivity, c as validateHelpRequest, l as validateProcedure, n as assertPublicToken, o as validateDecision, s as validateHandoff } from "./validation-C0ioxYEO.mjs";
import { t as createClient } from "../_libs/supabase__supabase-js.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/sharedServerFns-Br32q6Wm.js
...
var deleteProcedureServer_createServerFn_handler = createServerRpc({
	id: "07f8a8539ff30513ccd4f7a821ed7c3aaa38444fd87a4f3b9bb2a984c71e23f2",
	name: "deleteProcedureServer",
	filename: "src/server/sharedServerFns.ts"
}, (opts) => deleteProcedureServer.__executeServer(opts));
var deleteProcedureServer = createServerFn({ method: "POST" }).validator(ownerIdInput).handler(deleteProcedureServer_createServerFn_handler, async ({ data }) => {
	await unwrap(rpcClient().rpc("delete_owner_procedure", {
		p_owner_token: getOrCreateOwnerCapability(),
...
var deleteHandoffServer_createServerFn_handler = createServerRpc({
	id: "91ac549a7423922427f249f33692513ae982e5d695dfc7817a26d43e8380371d",
	name: "deleteHandoffServer",
	filename: "src/server/sharedServerFns.ts"
}, (opts) => deleteHandoffServer.__executeServer(opts));
var deleteHandoffServer = createServerFn({ method: "POST" }).validator(ownerIdInput).handler(deleteHandoffServer_createServerFn_handler, async ({ data }) => {
	await unwrap(rpcClient().rpc("delete_owner_handoff", {
		p_owner_token: getOrCreateOwnerCapability(),
		p_external_id: data.id
	}));
});
