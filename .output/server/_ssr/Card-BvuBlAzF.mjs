...
import { a as validateActivity, c as validateHelpRequest, d as validatePublicHelpRequest, i as isExpired, l as validateProcedure, n as assertPublicToken, o as validateDecision, r as generatePublicToken, s as validateHandoff, t as assertHandoffTransition, u as validatePublicHandoff } from "./validation-C0ioxYEO.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/Card-BvuBlAzF.js
...
var deleteProcedureServer = createServerFn({ method: "POST" }).validator(ownerIdInput).handler(createSsrRpc("07f8a8539ff30513ccd4f7a821ed7c3aaa38444fd87a4f3b9bb2a984c71e23f2"));
...
var deleteHandoffServer = createServerFn({ method: "POST" }).validator(ownerIdInput).handler(createSsrRpc("91ac549a7423922427f249f33692513ae982e5d695dfc7817a26d43e8380371d"));
...
var LOCAL_SANDBOX_KEYS = /* @__PURE__ */ new Set([
	"recordings",
	"accounts",
	"runs"
]);
async function resetDemo(repositories) {
	const tasks = [
		...
		["helpRequests", repositories.helpRequests.replaceAll(DEMO_SEED.helpRequests ?? [])],
...
async function applyRecipientCommand(repositories, account, command, options) {
	...
	repositories.activity.appendForHandoffToken(options.handoffToken, {
		id: `activity-${result.event.id}`,
		kind: "command",
		timestamp,
		source: options.source ?? "human",
